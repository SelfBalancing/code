...
let Chapter14EightBitAdder = 
{
    ...
    transform: {x: -10, y: 200, scale: 1, rotate: 0},
    ...
    [
        ...
        { name: "carryLight", type: "BitLight", x:-120, relative: { xy: { name: "adder7.light"}}},
        { name: "jt1", type: "Joint", y:25, relative: { xy: { name: "adder7.fuller.carryOr", io: "out"}}},
        { name: "jt2", type: "Joint", relative: { x: { name: "carryLight" }, y: { name:"jt1"}}},
        ...
        { name: "sum", type: "DynamicDecimal", text: "0", x: 120, relative: { xy: { name:"adder0.light" }}, 
            digits: {0: "adder0.light", 1: "adder1.light", 2: "adder2.light", 3: "adder3.light", 
                        4: "adder4.light", 5: "adder5.light", 6: "adder6.light", 7: "adder7.light", 8: "carryLight"}}
    ],
    wires:
    [
        ...
        { points: [ { name:"adder7.fuller.carryOr", io: "out"}, { name:"jt1"}, { name: "jt2"}, { name:"carryLight", io: "top"}]}            
    ]
}
