// Chapter14OneBitFullAdder (c) Charles Petzold, 2024
// ©️自权的SPACE 2025 汉化

let Chapter14OneBitFullAdder = 
{
    name: "Chapter14OneBitFullAdder",
    transform: {x: -20, y: 55, scale: 1, rotate: 0},
    propagationDelay: 100,
    components:
    [
        { name: "fuller", type: "External", file: "Chapter14OneBitFuller", scale: 0.65, y: 26 },

        { name: "buttonA", type: "DigitButton", x: 80, relative: { y: { name:"fuller.halfer1.summer.or", io: "A" }}},
        ...
        { name: "labelCarry", type: "Label", text: "CARRY", xAlign: 0.5, yAlign: 0, y: 50, relative: { xy: { name:"carryLight" }}},
